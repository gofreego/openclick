...
**OpenClick** is an open-source, self-hostable product analytics platform built for speed and low memory footprint. It provides event tracking, session replay, funnel analysis, feature flags, and cohort analytics — the full feature set of PostHog — without the operational complexity of a multi-service distributed system.
